...
from common.table_class.chord_old import Table_Chord11, Table_Whole_Chord
from sqlalchemy.orm import sessionmaker
from debug_and_test.old.make_whole_chord_old import the_function


def make_whole_chord11():
    print("开始处理 「 十一和弦 」 ... ")
    ...
    adjust_list = [None, "sus2", "sus4", "add4", "add6", "sharp5", "flat5", "omit3", "omit5", "omit7", "omit9",
                   "sus2_omit5",
